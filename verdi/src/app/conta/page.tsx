  ...
  return (
    <section>
      ...
      <div className='border-2 border-green-700 w-[90vw] p-2 mt-8 sm:w-96 xl:w-[33vw] flex flex-col gap-5'>
        <p className='text-creme lg:text-xl'>Quilômetros Percorridos - {quilometrosPercorridos}</p>
        <p className='text-creme lg:text-xl'>Pontos Conquistados - {pontosConquistados}</p>
        <p className='text-creme lg:text-xl'>Créditos - {creditos}</p>
      </div>
